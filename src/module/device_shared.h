...
#define UMS_DEV_SWITCH_TO_WORKER_THREAD     _IOR(UMS_DEV_IOCTL_MAGIC, 9, int)
#define UMS_DEV_SWITCH_BACK_TO_UMS_THREAD   _IOR(UMS_DEV_IOCTL_MAGIC, 10, yield_reason_t)
